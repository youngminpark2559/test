...
BT_list_path="/mycodehtml/cv/unsupervised-learning-intrinsic-images/BT_list.txt"
lines_list=[]
with open(BT_list_path) as f:
    lines=f.readlines()
    lines_list.extend(lines)
num_imgs=len(lines_list)

# ======================================================================
# Switch binary string and ordinary string

import urllib.request

# Get data file
f = urllib.request.urlopen("https://archive.ics.uci.edu/ml/machine-learning-databases/iris/iris.data")
# Read data file and assign it as binary string
raw_data = f.read()
...
# Decode binary string into ordinary string in ascii
print(raw_data.decode('ascii'))
# Decode binary string into ordinary string in utf-8
...
# Decode binary sting into ordinary string in ascii
b'a string'.decode('ascii')
# 'a string'

# Encode ordinary string in ascii into binary string
